/**
 * Will be used as a utility.
 * Will contain the data of a virtual market, and a 
...
function updateMarket() {
    // Update market with random numbers to show live data changes
    ...
    // add new data to beginning of marketPositions
