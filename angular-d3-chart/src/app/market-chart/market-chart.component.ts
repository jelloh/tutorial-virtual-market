...
export class MarketChartComponent implements OnChanges {
  // Local reference to the div (chartElement) #chart
  @ViewChild('chart')
  chartElement: ElementRef;

  // method that converts string values to Date objects
  parseDate = d3.timeParse('%d-%m-%Y');

  // This component's INPUT
  // Send in the marketPrice data (or some data)
  // By having input like this, rather than having the component itself use the 
  // service to pull data... we can reuse the component in other areas if we want to!
  @Input()
  marketStatus: MarketPrice[];

  // used to hold the reference of the svg element ...
  private svgElement: HTMLElement;
  // ... and properties of the chart
  private chartProps: any;
  // both will be used to re-render the chart
  ...
  /**
   * Format all received dates in marketStatus
   */
  formatDate(){
